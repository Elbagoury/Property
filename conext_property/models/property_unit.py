...
class property_unit(models.Model):
    ...
    property_ok 			= fields.Boolean(string="Property", default=False)
    tipe                            = fields.Selection([('landed_house','Landed House'),
                                                        ('apartement','Apartement'),
                                                        ('hotel','Hotel')], string="Tipe")
    address                 = fields.Char(string="Alamat")
    property_category_id    = fields.Many2one(comodel_name="property.category", string="Nama Cluster/Apartement/Hotel")
    property_view_id        = fields.Many2one(comodel_name="property.view", string="Zona")
...
class property_unit_price(models.Model):
    ...
    property_unit_id    = fields.Many2one(comodel_name="product.template", string="ID Unit")
...
class property_unit_rental_price(models.Model):
    ...
    property_unit_id = fields.Many2one(comodel_name="product.template", string="Property Unit")
